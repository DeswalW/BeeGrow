...
<aside
    class="fixed md:absolute drawer top-0 left-0 z-40 w-60 md:w-80 h-full bg-white md:bg-gray-50 overflow  transition-transform -translate-x-full md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
    aria-label="Sidenav"
    id="filter"
>
    <div class="flex flex-col h-full">
        <!-- Header Filter - Fixed at top -->
        <div class="sticky md:static top-0 px-6 md:pl-10 lg:pl-20 pt-24">
        ...
        <!-- Scrollable Content -->
        <div class="flex-1 overflow-y-auto px-6 md:pl-10 lg:pl-20 pb-10 no-scrollbar">
